...
export default class SMedia_Link implements IScript<Props> {
  ...
  spawn(host: Entity, props: Props, channel: IChannel) {
    ...
    if (props.bnw) {
      link.addComponent(new GLTFShape('8bd080c9-9954-43b2-a6ac-0b0913d298c0/models/discord_bnw.glb'))
    } else {
      link.addComponent(new GLTFShape('8bd080c9-9954-43b2-a6ac-0b0913d298c0/models/discord.glb'))
    }
